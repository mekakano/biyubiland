...
class LineChartWoi extends StatefulWidget {
  final Widget? child;

  const LineChartWoi({Key? key, this.child}) : super(key: key);

  _LineChartWoiState createState() => _LineChartWoiState();
}

class _LineChartWoiState extends State<LineChartWoi> {
